...
class OAuth2DataHandler extends DataHandler[UserInfo] {
  ...
  override def createAccessToken(
    authInfo: oauth2.AuthInfo[UserInfo]): Future[oauth2.AccessToken] = ???
  ...
  override def getStoredAccessToken(
    authInfo: oauth2.AuthInfo[UserInfo]): Future[Option[oauth2.AccessToken]] = ???
  ...
  override def refreshAccessToken(
    ...
    refreshToken: String): Future[oauth2.AccessToken] = ???
  ...
  override def findAuthInfoByCode(
    code: String): Future[Option[oauth2.AuthInfo[UserInfo]]] = ???
  ...
  override def findAuthInfoByRefreshToken(
    refreshToken: String): Future[Option[oauth2.AuthInfo[UserInfo]]] = ???
  ...
  override def findAccessToken(
    token: String): Future[Option[oauth2.AccessToken]] = ???
  ...
  override def findAuthInfoByAccessToken(
    accessToken: oauth2.AccessToken): Future[Option[oauth2.AuthInfo[UserInfo]]] = ???
}
